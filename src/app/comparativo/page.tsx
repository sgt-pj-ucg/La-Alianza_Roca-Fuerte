...
export default function ComparativoPage() {
  ...
  const model = useMemo(() => {
    ...
    return { records, itemRows, categories: [...categories.values()].sort((a, b) => b.actual - a.actual), annualBudget, totalExpense, totalIncome, plannedToDate, monthsClosed, projectedExpense, execution, annualExecution, calendarPace, filteredItems };
