...
export default function CartolasPage() {
  ...
  return <main className="statement-page"><header className="statement-header"><a href="/">← Presupuesto 2026</a><div><p className="eyebrow">CARTOLAS BANCARIAS</p><h1>Cargar y conciliar</h1></div></header>
