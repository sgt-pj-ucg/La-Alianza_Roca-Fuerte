...
export default function CartolasPage() {
  ...
  return <AuthGate><main className="statement-page"><header className="statement-header"><a href="/" className="back-link" aria-label="Volver al panel de tesorería"><span className="back-link-icon" aria-hidden="true">←</span><span><small>Panel de tesorería</small>Presupuesto 2026</span></a><div><p className="eyebrow">CARTOLAS BANCARIAS</p><h1>Cargar y conciliar</h1></div></header>
