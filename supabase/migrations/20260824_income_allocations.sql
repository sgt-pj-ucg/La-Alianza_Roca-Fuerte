-- Distribución de ingresos en una o más partidas.
...
create policy "treasurer manages income allocations"
  on public.transaction_income_allocations for all to authenticated
